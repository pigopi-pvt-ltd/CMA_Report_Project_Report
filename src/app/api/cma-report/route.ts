...
import CmaReport from "@/db/models/cmaReportModel"; // Import name fixed
...
export async function POST(request: Request) {
  try {
    ...
    const yearlyGrowthRate = .05;//(data.revenueDetails.yearlyGrowthRate) * .01;
    ...
    const project = await CmaReport.create(finalData);
