...
export const businessRequirementsKeyEnum = z.enum([
  "machinery", "land", "building", "computersAndAccessories", "furnituresAndFixtures",
  "vehicle", "softwareWebsiteAndApp", "liveStockFarmAnimals", "otherFixedExpenses",
  "consumablesStocks", "rawMaterials", "workingExpenses",
]);

export const monthlyExpensesKeyEnum = z.enum([
  "salary", "purchaseOfEquipments", "freight", "powerAndFuel", "printingAndStationery",
  "advertisement", "miscellaneousExpenses", "postageAndCourier", "transportAndConveyance",
  "staffWelfare", "repairAndMaintenance", "rent", "electricityExpenses", "purchaseOfRawMaterials",
  "otherExpenses",
]);
...
export const projectReportSchema = z.object({
  ...
  loanPeriod: z.number({ message: "Loan period is required" }).int().min(5, "Loan period must be at least 5 years").max(10, "Loan period cannot exceed 10 years"),
