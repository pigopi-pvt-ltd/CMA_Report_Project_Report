                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 mb-12">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex gap-4 mt-4">
                            ...
                            <a href="https://www.facebook.com/people/PigoPi/61576543783204/?sk=about" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg bg-secondary text-muted-foreground transition-all duration-[400ms] ease-in-out hover:-translate-y-1 hover:text-white hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-700 hover:shadow-[0_8px_20px_-5px_rgba(37,99,235,0.5)]" title="Facebook">
                            ...
                            <a href="https://www.instagram.com/pigopi_pvt_ltd?igsh=MXQ0cjl4bTBnbDc1Mg==" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg bg-secondary text-muted-foreground transition-all duration-[400ms] ease-in-out hover:-translate-y-1 hover:text-white hover:bg-gradient-to-br hover:from-pink-500 hover:to-fuchsia-600 hover:shadow-[0_8px_20px_-5px_rgba(236,72,153,0.5)]" title="Instagram">
                            ...
                            <a href="https://www.linkedin.com/company/pigopi-private-limited/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg bg-secondary text-muted-foreground transition-all duration-[400ms] ease-in-out hover:-translate-y-1 hover:text-white hover:bg-gradient-to-br hover:from-sky-600 hover:to-sky-700 hover:shadow-[0_8px_20px_-5px_rgba(2,132,199,0.5)]" title="LinkedIn">
